    ...
    <section className="py-20 bg-[#FAF8F4] text-[#1A1D20] border-b border-[#E6DBC6]/40 overflow-hidden">
      <Container>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
          ...
          <div className="lg:col-span-6 relative flex flex-col justify-start" data-aos="fade-right" data-aos-duration="800">
          ...
          <div className="lg:col-span-6 flex flex-col justify-between text-left" data-aos="fade-left" data-aos-duration="800">
